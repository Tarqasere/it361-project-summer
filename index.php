  ...
  <body>
   ...
   <header class="header">
    ...
    <nav class="header-links">
      <a href="club-style-sheet.css" class="active">Home</a>
      ...
      <div class="Events-Header">
        ...
        <div class="Event-cards">
          <!--card1-->
           ...
           <img class="thumb"src="images/MATH.jpg"/>
           <div class="card-info">
            <div class="card-name">
              <p>Event</p> 
                <h3>Math</h3>
           ...
           <!--card3-->
            <div class="card">
              <div class="card-effect">
            <img class="thumb"src="images/PHISICS.jpg"/>
           <div class="card-info">
            <div class="card-name">
              <p>Event</p> 
                <h3>Physics</h3>
           ...
           <!--card3-->
                  <div class="card">
                    <div class="card-effect">
           <img class="thumb"src="images/ROBOTICS.jpg"/>
           <div class="card-info">
            <div class="card-name">
              <p>Event</p> 
                <h3>Robotics</h3>
